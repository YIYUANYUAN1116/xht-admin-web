...
//引入组合式API函数ref
import type {CategoryObj,CategoryResponseData } from "@/api/product/category/type"
import { getCategory,reqAddOrUpdateCategory,reqRemoveCategory } from "@/api/product/category/index"
...
const getCategorybyParentId = async (pId=0,resolve:(data: CategoryObj[]) => void)  => {
